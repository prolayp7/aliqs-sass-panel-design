...
const concepts = [
  ...
  { id: "03", name: "Conversation Pulse", description: "A transcript-first qualification workspace.", palette: ["#17181B", "#B8F34A", "#FB4D77"], available: false },
  ...
  return (
    <main className="gallery-shell">
      ...
      <section className="gallery-intro">
        ...
        <p>Choose a direction to review the same qualification workflow through a different visual and operational lens. Designs 01 and 02 are ready to explore.</p>
      </section>
